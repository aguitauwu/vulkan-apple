...
The project serves as a proof of concept and foundation for [Prism](https://github.com/aguitauwu/prism), a universal graphics API translation layer targeting Vulkan as its backend.
...
No render pass. No pipeline. No shaders. Pure buffer-to-image copy using Vulkan's transfer queue.
...
The original Bad Apple video (Niconico, 2009) runs at 30fps at 480x360. Frames are upscaled to 1280x720 and interpolated to 60fps using ffmpeg's fps filter before extraction.
